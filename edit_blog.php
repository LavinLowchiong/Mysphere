<?php
// public_html/edit_blog.php - Blog Editor for Existing Posts
...
// Authorization: Only logged-in users can access the editor
...
// FINAL AUTHORIZATION CHECK: Ensure the current user is the author
if ((int)$blog['user_id'] !== $current_user_id) {
    // This handles the core authorization rule: user cannot edit another's blog
    $_SESSION['message'] = ['type' => 'error', 'text' => 'Access denied. You can only edit your own blogs.'];
    header("Location: /index.php");
    exit();
}

$page_title = 'Edit Blog Post: ' . $blog['title'];
$button_text = 'Save Changes';
// Note: $blog['title'] and $blog['content'] are pre-populated in the form below
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="bg-white p-6 rounded-xl shadow-lg">
            ...
            <form action="/backend/blog_handler.php" method="POST" class="space-y-6">
                ...
                <div class="flex justify-end space-x-4">
                    <a href="/view_blog.php?id=<?php echo $blog['id']; ?>" class="py-3 px-6 rounded-lg text-gray-600 hover:bg-gray-200 transition duration-150 font-medium">
                        Cancel
                    </a>
                    <button type="submit"
