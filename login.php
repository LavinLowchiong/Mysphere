...
// Check if a POST request was made and the action handler failed to redirect (i.e., login failed)
// The auth_handler.php file will process the POST request and set a session message.
